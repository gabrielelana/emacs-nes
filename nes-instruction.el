...
(aset nes/instruction:MAP #x0C (make-nes/instruction :func #'nes/instruction-nopi :name "NOPI" :mode :absolute))
(aset nes/instruction:MAP #x1C (make-nes/instruction :func #'nes/instruction-nopi :name "NOPI" :mode :absolute-x))
(aset nes/instruction:MAP #x3C (make-nes/instruction :func #'nes/instruction-nopi :name "NOPI" :mode :absolute-x))
(aset nes/instruction:MAP #x5C (make-nes/instruction :func #'nes/instruction-nopi :name "NOPI" :mode :absolute-x))
(aset nes/instruction:MAP #x7C (make-nes/instruction :func #'nes/instruction-nopi :name "NOPI" :mode :absolute-x))
(aset nes/instruction:MAP #xDC (make-nes/instruction :func #'nes/instruction-nopi :name "NOPI" :mode :absolute-x))
(aset nes/instruction:MAP #xFC (make-nes/instruction :func #'nes/instruction-nopi :name "NOPI" :mode :absolute-x))
...
(defun nes/instruction-jsr (c address _mode)
  (let* ((register (nes/cpu->register c))
    ...
    (nes/cpu-push c (logand (ash pc -8) #xFF))
...
(defun nes/instruction-nopi (_c _address _mode)
  "No Operation.")
